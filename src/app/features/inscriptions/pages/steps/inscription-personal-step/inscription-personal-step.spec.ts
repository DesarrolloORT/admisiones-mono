...
describe('InscripcionPersonalStep', () => {
  ...
  it('keeps generated survey fields bound in the section templates', () => {
    const education = readFileSync(
      'src/app/features/inscriptions/pages/steps/inscription-personal-step/sections/inscription-education-section/inscription-education-section.html',
      'utf8'
    );
    const decision = readFileSync(
      'src/app/features/inscriptions/pages/steps/inscription-personal-step/sections/inscription-academic-decision-section/inscription-academic-decision-section.html',
      'utf8'
    );
