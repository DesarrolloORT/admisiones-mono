...
export function createScholarshipPersonalForms() {
  return {
    ...
    declarationForm: new FormGroup({
      ...
      savingsAmount: new FormControl<number | null>(null),
      studyPlan: new FormControl<string | null>(null, Validators.required),
      housingExpenses: new FormControl<number | null>(null),
      otherServicesExpenses: new FormControl<number | null>(null),
      healthExpenses: new FormControl<number | null>(null),
      personalExpenses: new FormControl<number | null>(null),
      transportationExpenses: new FormControl<number | null>(null),
