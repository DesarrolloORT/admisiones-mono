import { createEnrollmentForms, createSectionConfig } from '../models/enrollment-flow-forms';

export class EnrollmentFormsStore {
  public readonly forms = createEnrollmentForms();
