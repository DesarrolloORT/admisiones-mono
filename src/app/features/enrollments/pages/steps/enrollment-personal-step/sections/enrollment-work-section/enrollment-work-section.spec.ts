...
import { EnrollmentWorkSection } from './enrollment-work-section';
...
describe('EnrollmentWorkSection', () => {
  let fixture: ComponentFixture<EnrollmentWorkSection>;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [EnrollmentWorkSection],
      providers: [{ provide: EnrollmentSurveyFacade, useValue: facade }],
    });
  });

  function createFixture(): void {
    fixture = TestBed.createComponent(EnrollmentWorkSection);
    fixture.componentRef.setInput('orientation', 'vertical');
    fixture.detectChanges();
  }

  it('renders only the corporate enrollment control', () => {
    createFixture();
  ...
  it('shows the required error for isCorporate when touched and invalid', () => {
    ...
    const error = fixture.nativeElement.querySelector('#corporate-enrollment-error');
    ...
    expect(fieldset.getAttribute('aria-describedby')).toContain('corporate-enrollment-error');
  });
});
