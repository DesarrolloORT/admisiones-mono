...
namespace UnitTesting.AppLogic.Platform.Serialization
{
    public class JsonSerializationHelperTests
    {
        ...
        public void TryDeserialize_WithValidJson_ReturnsObject()
        {
            ...
            var result = JsonSerialization.TryDeserialize<SampleDto>(json, JsonSerializationDefaults.Redis);
        ...
        {
            var result = JsonSerialization.TryDeserialize<SampleDto>(json);
        ...
        {
            var result = JsonSerialization.TryDeserialize<SampleDto>("{ not valid json ");
