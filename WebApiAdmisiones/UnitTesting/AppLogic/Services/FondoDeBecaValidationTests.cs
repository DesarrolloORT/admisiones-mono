...
{
    public class FondoDeBecaValidationTests
    {
        [Fact]
        public void ValidarSolicitudGuardadoDeclaracion_Null_ReturnsExpectedError()
        {
            var result = FondoDeBecaValidation.ValidarSolicitudGuardadoDeclaracion(
                null,
                "TestMethod");
        ...
        {
            var result = FondoDeBecaValidation.ValidarSolicitudGuardadoDeclaracion(
                new DtoDeclaracionJuradaWebDevart { IdInscriptoPrueba = 0 },
                "TestMethod");
        ...
        public void ValidarConfirmacionDeclaracion_UniversidadOrtSinFacultad_ReturnsExpectedError()
        {
            var declaracion = new DeclaracionJuradaWeb
            {
                ...
                CodigoInstitucionUniv = FondoDeBecaConstants.Declaracion.CodigoInstitucionOrt,
        ...
        {
            var result = FondoDeBecaValidation.ValidarArchivoAdjunto(
                [],
                "adjunto.pdf",
                "TestMethod");
