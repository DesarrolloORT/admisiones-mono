...
public interface IPendingPersonStore
{
    ...
    Task<PendingPerson?> GetAsync(string flowId);
    ...
    /// </summary>
    Task<string?> ResolveFlowIdByDocumentAsync(string documentType, string document);
}
