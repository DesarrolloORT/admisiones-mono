...
2. Si el documento es `CI`, resolver la rama segun el resultado:
   ...
   - `RequiereVerificacion`: pedir datos de verificacion y llamar a `VerificarIdentidad`.
...
4. Cuando corresponde elegir carrera y comienzo, llamar a `ConfirmarPersonaExistente`.
