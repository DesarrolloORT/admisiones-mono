...
{
    public partial class MotivoEleccionAdmisionRepository
    {
        public virtual ICollection<BusinessLogic.Entities.MotivoEleccionAdmision> GetByPersona(long codigoPersona)
        {
            return objectSet
