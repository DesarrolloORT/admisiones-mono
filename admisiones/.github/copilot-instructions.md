...
- Un service existe solo si aporta comportamiento; si un metodo solo reenvia al adapter, el consumidor (page, component, resolver o facade) inyecta el adapter.
