 ...
 * paso): lee los `FormGroup` de `ScholarshipProcessFacade` (que es su dueña,
 * para que sobrevivan al cambio de paso) y resuelve qué
...
export class ScholarshipPersonalFacade {
  ...
  public readonly personalDataForm = this.processFacade.personalDataForm;
  public readonly educationInfoForm = this.processFacade.educationInfoForm;
  public readonly educationInfoFbrForm = this.processFacade.educationInfoFbrForm;
  public readonly educationInfoFclForm = this.processFacade.educationInfoFclForm;
  public readonly workHistoryForm = this.processFacade.workHistoryForm;
  public readonly declarationForm = this.processFacade.declarationForm;
