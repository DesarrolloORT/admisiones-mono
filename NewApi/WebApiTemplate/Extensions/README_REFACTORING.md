...
### 1. `WebApiFDP/Extensions/TelemetryExtensions.cs`
...
### 2. `WebApiFDP/Extensions/ServiceCollectionExtensions.cs`
...
### 3. `WebApiFDP/Extensions/DomainServicesExtensions.cs`
...
### 4. `WebApiFDP/Extensions/MiddlewarePipelineExtensions.cs`
...
### 5. `WebApiFDP/Extensions/KestrelExtensions.cs`
...
### Build
```bash
dotnet build FichaDePersona/WebApiFDP.sln --configuration Release
```
...
- ? `sonarQube&TestCoverageWebApiFDP.yml` - Sin cambios
