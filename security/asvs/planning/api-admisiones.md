# api-admisiones — preparación OWASP ASVS 5.0.0

Fecha: 2026-09-16. Rama local: fix/owasp. Estado: planificación; sin cambios de código ni fixes.

Base del clone original: 771229f94082f4ecca1ee2b85b22849f89b3b9ae. Los cambios locales sin commit no se incluyen en el worktree de esta rama.

Responsabilidad candidata: API .NET, reglas de negocio, autenticación LDAP/JWT/MFA, sesiones, autorización, validación y archivos, persistencia e integraciones.
...
- Primero: V6/V7/V8/V9 (login y recuperación, MFA, cookies/refresh, firma JWT y permisos por recurso con dos usuarios).
- Luego: V1/V2/V4/V5 (validación del servidor, consultas y LDAP, contratos, anti-automatización, archivos y abuso de flujos de registro/inscripción/pago).
- Finalmente: V11/V12/V13/V14/V15/V16 (criptografía, conexiones salientes, secretos, datos sensibles, dependencias y logs).
- Coordinar frontend/infraestructura: V3 requiere headers y cookies efectivos. Inventariar Core consumido; no editar código Devart generado en una futura remediación.
...
| Sección | IDs L1/L2 (PENDING) | IDs L3 (fuera del objetivo; PENDING) |
| --- | --- | --- |
| V9.1 — Token source and integrity | v5.0.0-9.1.1, v5.0.0-9.1.2, v5.0.0-9.1.3 | — |
| V9.2 — Token content | v5.0.0-9.2.1, v5.0.0-9.2.2, v5.0.0-9.2.3, v5.0.0-9.2.4 | — |
