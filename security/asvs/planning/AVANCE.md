...
Actualizado: 2026-09-18 (v5.0.0-6.2.8). Fase: análisis y documentación exclusivamente L1; fixes no autorizados.

## Checkpoint actual

- Requisito en curso: ninguno.
- Siguiente requisito: v5.0.0-6.3.1 (L1).
- Último requisito documentado: v5.0.0-6.2.8 (L1), FAIL.
- Selección vigente: solo L1, en orden oficial; L2 reservado para una fase posterior con pedido explícito del usuario.
- Progreso L1: 35 DOCUMENTADO, 0 EN_CURSO, 35 POR_REVISAR (total 70).
- L2 reservado: 2 DOCUMENTADO y 181 POR_REVISAR (total 183); se preservan sus estados y fichas.
- Progreso general L1/L2 conservado: 37 DOCUMENTADO, 0 EN_CURSO, 216 POR_REVISAR.
- L3: 92 FUERA_L2; no se consideran NOT_APPLICABLE.
- Próxima acción: con un nuevo pedido de seguir, revisar únicamente v5.0.0-6.3.1 (L1); verificar Git/fuente y fijar refs antes de investigar.
