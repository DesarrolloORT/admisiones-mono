...
- v5.0.0-10.4.1 DOCUMENTADO / NOT_APPLICABLE: la API y el frontend implementan autenticación propia por LDAP, JWT y cookies, sin endpoint OAuth/OIDC de autorización, registro de cliente, `redirect_uri`, `response_type` ni callback. El JWT de servicio saliente para Inscripciones y Pagos no procesa redirecciones y su propia documentación lo describe como client-credentials “simplificado”; el sistema externo no fue evaluado. Evidencia, límites y pendiente de inventario externo en [ficha](./revisiones/v5.0.0-10.4.1.md). HEAD `73cc7c44385b98b1bfd3ed8ac4d8dceb34a1d21e`; frontend `86979de2bbe049fdeddeae3dbb263508403dd5d8`; API `260667f6025167dcdbe80452443a1a43ca631a65`; Core `01239cdf6054dc5a450dcdaa3a867ae3204b61e7`; blob oficial validado sobre LF normalizado. La API y frontend tienen cambios ajenos amplios; evidencia fijada con hashes de archivos inspeccionados. Sin fixes, tests ejecutados, runtime, builds, scans, regeneración OpenAPI, commits ni pushs. Archivos propios de esta iteración sin commit: AVANCE.md y ficha 10.4.1. Continuar sólo con nuevo pedido: «Seguí ITERACION.md y revisá únicamente v5.0.0-10.4.2».
- v5.0.0-9.2.1 DOCUMENTADO / NEEDS_REVIEW: la configuración estática valida lifetime en los dos validadores de JWT entrantes y los emisores propios incluyen expiración; enlace y sesión temporal validan antes de usar `purpose`/`sub`. Faltan pruebas reproducibles de `exp` vencido, `nbf` futuro, límites de clock skew, configuración efectiva y receptor externo del JWT de servicio. Evidencia, propuesta documental y pendientes en [ficha](./revisiones/v5.0.0-9.2.1.md). HEAD `73cc7c44385b98b1bfd3ed8ac4d8dceb34a1d21e`; frontend `86979de2bbe049fdeddeae3dbb263508403dd5d8`; API `260667f6025167dcdbe80452443a1a43ca631a65`; Core `01239cdf6054dc5a450dcdaa3a867ae3204b61e7`; blob oficial validado sobre LF normalizado. La API tiene cambios ajenos amplios; evidencia fijada con hashes de archivos JWT inspeccionados. Sin fixes, tests ejecutados, runtime, builds, scans, regeneración OpenAPI, commits ni pushs. Archivos propios de esta iteración sin commit: AVANCE.md y ficha 9.2.1. Continuar sólo con nuevo pedido: «Seguí ITERACION.md y revisá únicamente v5.0.0-10.4.1».
- v5.0.0-9.1.3 DOCUMENTADO / NEEDS_REVIEW: los validadores JWT entrantes obtienen claves desde variables de entorno y un mapeo local preconfigurado por issuer; no se observó consumo de `jku`, `x5u` ni `jwk`, y `kid` no participa en la selección. La evidencia es estática: faltan pruebas con headers maliciosos, el aprovisionamiento efectivo de secretos y la evaluación del receptor externo del JWT de servicio. Evidencia, propuesta y pendientes en [ficha](./revisiones/v5.0.0-9.1.3.md). HEAD `73cc7c44385b98b1bfd3ed8ac4d8dceb34a1d21e`; frontend `86979de2bbe049fdeddeae3dbb263508403dd5d8`; API `260667f6025167dcdbe80452443a1a43ca631a65`; Core `01239cdf6054dc5a450dcdaa3a867ae3204b61e7`; blob oficial validado sobre LF normalizado. La API tiene cambios ajenos amplios; evidencia fijada con hashes de archivos JWT inspeccionados. Sin fixes, tests ejecutados, runtime, builds, scans, regeneración OpenAPI, commits ni pushs. Archivos propios de esta iteración sin commit: AVANCE.md y ficha 9.1.3. Continuar sólo con nuevo pedido: «Seguí ITERACION.md y revisá únicamente v5.0.0-9.2.1».
- v5.0.0-9.1.2 DOCUMENTADO / FAIL: el bearer de acceso declara una allowlist explícita de sólo HS256, coherente con su emisor. En cambio, el validador común de enlaces y sesiones temporales de activación exige firma, emisor, audiencia y vigencia, pero no declara `ValidAlgorithms` ni un validador de algoritmo equivalente; esos flujos aceptan claims tras usar ese validador. También falta evaluar el receptor externo del JWT de servicio hacia Inscripciones/Pagos. Evidencia, propuesta y pendientes en [ficha](./revisiones/v5.0.0-9.1.2.md). HEAD `73cc7c44385b98b1bfd3ed8ac4d8dceb34a1d21e`; frontend `86979de2bbe049fdeddeae3dbb263508403dd5d8`; API `260667f6025167dcdbe80452443a1a43ca631a65`; Core `01239cdf6054dc5a450dcdaa3a867ae3204b61e7`; blob oficial validado sobre LF normalizado. La API tiene cambios ajenos amplios; evidencia fijada con hashes de archivos JWT inspeccionados. Sin fixes, tests ejecutados, runtime, builds, scans, regeneración OpenAPI, commits ni pushs. Archivos propios de esta iteración sin commit: AVANCE.md y ficha 9.1.2. Continuar sólo con nuevo pedido: «Seguí ITERACION.md y revisá únicamente v5.0.0-9.1.3».
- v5.0.0-9.1.1 DOCUMENTADO / NEEDS_REVIEW: la configuración bearer exige `ValidateIssuerSigningKey` y resuelve una clave HMAC preconfigurada antes de aceptar el principal; el validador de sesión temporal usa `ValidateToken` con la misma exigencia antes de leer sus claims. La evidencia es estática y los tests existentes sólo inspeccionan opciones/resolvedor: faltan pruebas de tokens con payload/firma alterados, configuración efectiva e inventario del receptor externo del JWT de servicio. Evidencia, propuesta y pendientes en [ficha](./revisiones/v5.0.0-9.1.1.md). HEAD `73cc7c44385b98b1bfd3ed8ac4d8dceb34a1d21e`; frontend `86979de2bbe049fdeddeae3dbb263508403dd5d8`; API `260667f6025167dcdbe80452443a1a43ca631a65`; Core `01239cdf6054dc5a450dcdaa3a867ae3204b61e7`; blob oficial validado sobre LF normalizado. La API tiene cambios ajenos amplios; evidencia fijada con hashes de los archivos JWT inspeccionados. Sin fixes, tests ejecutados, runtime, builds, scans, regeneración OpenAPI, commits ni pushs. Archivos propios de esta iteración sin commit: AVANCE.md y ficha 9.1.1. Continuar sólo con nuevo pedido: «Seguí ITERACION.md y revisá únicamente v5.0.0-9.1.2».
- v5.0.0-8.3.1 DOCUMENTADO / FAIL: las operaciones privadas inspeccionadas aplican `[Authorize]`, derivan el `personId` del JWT validado y vuelven a consultar con él en casos de uso; los flujos anónimos cotejan `X-Flow-Id` contra Redis, sin depender sólo del guard Angular. Sin embargo, el host publica `/metrics` con `MapMetrics()` sin `RequireAuthorization`, policy ni fallback global, así que no toda operación expuesta tiene enforcement de autorización en una capa confiable. Faltan pruebas A/B de runtime, Oracle/Redis y controles efectivos de gateway. Evidencia, propuesta y pendientes en [ficha](./revisiones/v5.0.0-8.3.1.md). HEAD `73cc7c44385b98b1bfd3ed8ac4d8dceb34a1d21e`; frontend `86979de2bbe049fdeddeae3dbb263508403dd5d8`; API `260667f6025167dcdbe80452443a1a43ca631a65`; Core `01239cdf6054dc5a450dcdaa3a867ae3204b61e7`; blob oficial validado sobre LF normalizado. Evidencia API fijada con hashes por cambios ajenos amplios. Sin fixes, tests ejecutados, runtime, builds, scans, regeneración OpenAPI, commits ni pushs. Archivos propios de esta iteración sin commit: AVANCE.md y ficha 8.3.1. Continuar sólo con nuevo pedido: «Seguí ITERACION.md y revisá únicamente v5.0.0-9.1.1».
...
- v5.0.0-7.4.1 DOCUMENTADO / FAIL: logout sólo elimina cookies; no revoca el refresh activo en Oracle y el validador JWT acepta access tokens firmados y vigentes sin comprobar terminación. El frontend limpia estado local incluso ante falla de logout. Faltan pruebas integradas con tokens retenidos, configuración efectiva y consumidores externos; evidencia y propuestas en [ficha](./revisiones/v5.0.0-7.4.1.md). HEAD 4e602c603b7a53e9d9447e6fd230b80da89f850e; Core 01239cdf6054dc5a450dcdaa3a867ae3204b61e7; hash oficial validado sobre blob. Sin fixes, tests ejecutados, builds, scans, commits ni pushs. Archivos de esta iteración sin commit: AVANCE.md y ficha 7.4.1. Continuar sólo con nuevo pedido: «Seguí ITERACION.md y revisá únicamente v5.0.0-7.4.2».
...
- v5.0.0-6.2.7 DOCUMENTADO / NEEDS_REVIEW: los seis campos propios declaran autocomplete apropiado y no se localizó bloqueo propio de paste; falta verificar DOM, librería ortInput y gestores reales. El atributo appPasswordCopy de una confirmación no tiene implementación propia localizada; su efecto queda pendiente. Evidencia y método en [ficha](./revisiones/v5.0.0-6.2.7.md). HEAD 881bd638d4dd5639b6dc72e1b64482c4254ac2cb; Core 01239cdf6054dc5a450dcdaa3a867ae3204b61e7; hash oficial validado sobre blob. Sin commit: AVANCE.md y ficha 6.2.7. Sin fixes, tests, builds, scans, commits ni pushs. Continuar sólo con nuevo pedido: «Seguí ITERACION.md y revisá únicamente v5.0.0-6.2.8».
- v5.0.0-6.2.6 DOCUMENTADO / NEEDS_REVIEW: seis campos en login, establecimiento y cambio enlazan el tipo al helper, que inicia en `password` y sólo pasa a `text` por botón explícito. Tests existentes leídos, no ejecutados; falta validar el `input.type` final de cada flujo en navegador y confirmar pantallas externas. Evidencia y pendientes en [ficha](./revisiones/v5.0.0-6.2.6.md). HEAD fdd9f8d9fe23412f65185587dbb8c91bafb980ed; Core 01239cdf6054dc5a450dcdaa3a867ae3204b61e7; hash oficial validado sobre blob. Sin commit: AVANCE.md y ficha 6.2.6. Sin fixes, tests, builds, scans, commits ni pushs. Continuar sólo con nuevo pedido: «Seguí ITERACION.md y revisá únicamente v5.0.0-6.2.7».
...
| v5.0.0-6.2.6 | L1 | DOCUMENTADO | NEEDS_REVIEW | [Ficha](./revisiones/v5.0.0-6.2.6.md) |
| v5.0.0-6.2.7 | L1 | DOCUMENTADO | NEEDS_REVIEW | [Ficha](./revisiones/v5.0.0-6.2.7.md) |
| v5.0.0-6.2.8 | L1 | DOCUMENTADO | FAIL | [Ficha](./revisiones/v5.0.0-6.2.8.md) |
...
| v5.0.0-6.3.1 | L1 | DOCUMENTADO | NEEDS_REVIEW | [Ficha](./revisiones/v5.0.0-6.3.1.md) |
| v5.0.0-6.3.2 | L1 | DOCUMENTADO | NEEDS_REVIEW | [Ficha](./revisiones/v5.0.0-6.3.2.md) |
...
| v5.0.0-6.4.2 | L1 | DOCUMENTADO | FAIL | [Ficha](./revisiones/v5.0.0-6.4.2.md) |
...
| v5.0.0-7.4.1 | L1 | DOCUMENTADO | FAIL | [Ficha](./revisiones/v5.0.0-7.4.1.md) |
| v5.0.0-7.4.2 | L1 | DOCUMENTADO | FAIL | [Ficha](./revisiones/v5.0.0-7.4.2.md) |
...
| v5.0.0-8.1.1 | L1 | DOCUMENTADO | NEEDS_REVIEW | [Ficha](./revisiones/v5.0.0-8.1.1.md) |
...
| v5.0.0-8.3.1 | L1 | DOCUMENTADO | FAIL | [Ficha](./revisiones/v5.0.0-8.3.1.md) |
...
| v5.0.0-9.1.1 | L1 | DOCUMENTADO | NEEDS_REVIEW | [Ficha](./revisiones/v5.0.0-9.1.1.md) |
| v5.0.0-9.1.2 | L1 | DOCUMENTADO | FAIL | [Ficha](./revisiones/v5.0.0-9.1.2.md) |
| v5.0.0-9.1.3 | L1 | DOCUMENTADO | NEEDS_REVIEW | [Ficha](./revisiones/v5.0.0-9.1.3.md) |
| v5.0.0-9.2.1 | L1 | DOCUMENTADO | NEEDS_REVIEW | [Ficha](./revisiones/v5.0.0-9.2.1.md) |
...
| v5.0.0-10.4.1 | L1 | DOCUMENTADO | NOT_APPLICABLE | [Ficha](./revisiones/v5.0.0-10.4.1.md) |
